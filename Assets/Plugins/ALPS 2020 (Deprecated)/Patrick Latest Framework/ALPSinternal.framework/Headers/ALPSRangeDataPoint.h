...
-(id)initWithRange:(float)range beaconX:(float)beaconX beaconY:(float)beaconY beaconZ:(float)beaconZ slot:(UInt8)slot;
...
@property float beaconPosX;
@property float beaconPosY;
@property float beaconPosZ;
